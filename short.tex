...
perform real-time access monitoring and multi-person tracking. Web based
tecnologies supporting self and context aware objects in conjunction  with
...
construction~\cite{paoluzziMS:2014}, 2D and 3D engineering meshes, non-manifold geometric and solid models and meshes, and high-resolution 3D
...
extendible and customizable, i. e. able to adequately respond to any need of
...
split in several sub-problems, which consist in the computation of the sub-graphs relative to each individual space, more generally a single room.
...
\paragraph{Real-time multi-person tracking} Real-time multi-person tracking
...
computing (pyplasm and larcc \cite{Dicarlo:2014:TNL:2543138.2543294, paoluzziMS:2014}). The modeling process can be further
...
range of applications: IoT monitoring, real-time multi-person tracking and user
